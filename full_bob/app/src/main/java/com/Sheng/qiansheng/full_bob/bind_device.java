...
public class bind_device extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.Sheng.qiansheng.full_bob.R.layout.bind_device);
        Button button_bind = (Button) findViewById(com.Sheng.qiansheng.full_bob.R.id.button_bind_action);
        assert button_bind != null;
        button_bind.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText mDevID = (EditText) findViewById(com.Sheng.qiansheng.full_bob.R.id.editText_dev_id);
                EditText mMobNum = (EditText) findViewById(com.Sheng.qiansheng.full_bob.R.id.editText_mobile_num);
